    ...
    >
      ...
      <div className="max-w-md w-full mx-4">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-[#dc8d33] mb-2">Forgot Password</h1>
          <p className="text-[#dc8d33] text-lg font-bold">Enter your email to receive a password reset link</p>
        </div>
        ...
        <div className="glass-effect rounded-2xl p-8 shadow-2xl bg-white/80 backdrop-blur">
          ...
          <div className="mt-8 text-center">
            <p className="text-[#2D274B] font-bold">
              ...
              <Link to="/login" className="font-semibold hover:underline" style={{ color: '#dc8d33' }}>
                Sign in
              </Link>
            </p>
          </div>
