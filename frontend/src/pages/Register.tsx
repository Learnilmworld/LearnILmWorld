        ...
        <div className="bg-white/90 backdrop-blur-xl shadow-xl rounded-[28px] p-10 border border-blue-200 max-w-xl mx-auto">
          ...
          <div className="relative  min-h-[520px] overflow-hidden">
            <AnimatePresence initial={false} custom={stepIndex} mode="wait">
              <motion.div key={currentStep} custom={stepIndex} variants={containerVariants} initial="enter" animate="center" exit="exit" transition={{ type: 'spring', stiffness: 230, damping: 24 }} className="absolute inset-0 overflow-y-auto">
